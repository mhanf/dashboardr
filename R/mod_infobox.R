...
#'       tags$small(toupper("Nombre de passages"))
#'     ),
#'     # tooltip
#'     div(
...
#'       h3(textOutput(ns("value")), class = "m-0 p-0 text-start"),
#'       p(
#'         icon(
#'           "arrow-circle-up",
...
#'       icon(infobox_val$infobox_icon_name, class = "fa-3x"),
#'       style = "opacity: 0.2;"
#'     )
#'   )
#'
...
#'   #   subtitle_out <- 24#shiny::textOutput(ns("subtitle"))
#'   # } else {
...
#'   #
#'   #
#'   # valuebox_dep <- htmltools::htmlDependency(
#'   #   name = "valuebox",
#'   #   version = "0.0.1",
#'   #   package = "dashboardr",
#'   #   src = "assets",
#'   #   #script = "tooltip.js",
#'   #   stylesheet = c(file = "valuebox.css")
#'   # )
#'   #
#'   # tags$div(
...
#'     )
#'
#'     output$value <- shiny::renderText(infobox_val$infobox_value[1])
#'   })
#' }
